...
- Улучшить качество сбора данных (уменьшить пропуски)
- Стандартизировать форматы дат
- Расширить датасет для более точных выводов
- Внедрить валидацию на этапе внесения данных
